        ...
        return (
            <React.Fragment>
                <div className="home-btn d-none d-sm-block">
                    <Link to="/" className="text-dark"><i className="mdi mdi-home h2"></i></Link>
                </div>
                        ...
                        <Row className="justify-content-center">
                            <Col md={8} lg={6} xl={5}>
                                        ...
                                        <Row>
                                            <Col className="col-7">
                                                <div className="text-primary p-4">
                                                    ...
                                                    <p>Sign in to continue using Chrono.</p>
                                                </div>
                                            </Col>
                                        ...
                                        <div className="p-2">
                                            ...
                                            <AvForm className="form-horizontal" onValidSubmit={this.handleValidSubmit}>
                                                ...
                                                <div className="form-group">
                                                    <AvField name="email" label="Email" value="arjohnqafsignal@gmail.com" className="form-control" placeholder="Enter email" type="email" required />
                                                </div>

                                                <div className="form-group">
                                                    <AvField name="password" label="Password" value="password" type="password" required placeholder="Enter Password" />
                                                </div>
                                ...
                                <div className="mt-5 text-center">
                                    ...
                                    <p>© {new Date().getFullYear()} Chrono. Crafted with <i className="mdi mdi-heart text-danger"></i> by <a target="_blank" href="https://singledraft.com/">Singledraft</a></p>
                                </div>
                            </Col>
                        </Row>
                    </Container>
